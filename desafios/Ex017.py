...
print("O valor da hipotenusa em um triângulo retângulo, onde o cateto oposto vale {}^2 que é igual {},\n"
      "e o cateto adjacente vale {}^2 que é igual {}, a hipotenusa é igual a {}".format(cateto_oposto, pow(cateto_oposto, 2),  cateto_adjacente, pow(cateto_adjacente, 2), hipotenusa))
